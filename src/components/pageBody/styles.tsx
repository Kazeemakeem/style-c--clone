...
import{ PageText as BodyText} from "../helpers/PageText"
import{ PageItemWrapper as BodyItemWrapper} from "../helpers/ItemWrapper"
...
export const Wrapper = styled(BodyItemWrapper)`
    display: flex;
    margin-right: 1em;
